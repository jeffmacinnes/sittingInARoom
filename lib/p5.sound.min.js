      ...
      (i = function () {
        ...
        return (
          ...
          (l.prototype._collectDefaults = function (t) {
            var e = [];
            if (
              (this.isUndef(t.defaults) || (e = Object.keys(t.defaults)), !this.isUndef(t._super))
            )
    ...
    window,
      window.hasOwnProperty("webkitAudioContext") &&
        ...
        (AudioContext.prototype.createDynamicsCompressor = function () {
          ...
          return (
            n(t.threshold), n(t.knee), n(t.ratio), n(t.reduction), n(t.attack), n(t.release), t
          );
        }),
          ...
          return (
            (u.Expr = function () {
              ...
              try {
                ...
                throw (
                  (this._disposeNodes(), new Error("Tone.Expr: Could evaluate expression: " + t))
                );
              }
              this.output = i;
            }),
        ...
        (r = function (t) {
          ...
          return (
            ...
            (t.AudioToGain.prototype.dispose = function () {
              return (
                t.prototype.dispose.call(this), this._norm.dispose(), (this._norm = null), this
              );
            }),
            t.AudioToGain
          );
        ...
        (function (t, e, n) {
          ...
          },
          {
            ...
            value: function (t) {
              0 <= t &&
                t < 1 &&
                this._workletNode.port.postMessage({ name: "smoothing", smoothing: t });
            },
          },
          {
            key: "dispose",
    ...
    (p5.Envelope = function (t, e, n, i, r, o) {
      ...
      (p5.Envelope.prototype.ramp = function (t, e, n, i) {
        ...
        a < o
          ...
          : o < a &&
            (this.control.setTargetAtTime(o, r, this._rampDecayTC), (r += this._rampDecayTime)),
          void 0 !== s &&
            (o < s
      ...
      return (
        ...
        (function (t, e, n) {
          ...
          },
          {
            ...
            value: function (t) {
              return (
                "number" == typeof t && (this.panner.rolloffFactor = t), this.panner.rolloffFactor
              );
            },
          },
          {
